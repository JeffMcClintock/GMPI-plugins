...
public:
	...
	virtual int32_t MP_STDCALL initialize() override {return gmpi::MP_OK;}
...
public:
	...
	virtual int32_t MP_STDCALL onMouseMove( UINT flags, POINT point ) override;
	virtual int32_t MP_STDCALL onLButtonUp( UINT flags, POINT point ) override;
	virtual int32_t MP_STDCALL openWindow( void ) override;
	virtual int32_t MP_STDCALL closeWindow( void ) override;
...
public:
	...
	virtual int32_t MP_STDCALL measure( MpSize availableSize, MpSize& returnDesiredSize ) override;
	virtual int32_t MP_STDCALL arrange( MpRect finalRect ) override;
	virtual int32_t MP_STDCALL openWindow( HWND parentWindow, HWND& returnWindowHandle ) override;
	virtual int32_t MP_STDCALL closeWindow( void ) override;
	...
	// Handle common windows messages. Uses MP_STDCALL only to ease switching user code to/from SeGuiCompositedGfxBase.
